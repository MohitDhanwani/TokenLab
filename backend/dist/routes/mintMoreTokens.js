...
route.post("/", async (req, res) => {
    try {
        ...
        const mintMoreTokensInstruction = createMintToInstruction(mintPubkey, getAccountToMintInstruction, ownerPubkey, convertedMintAmount, [], TOKEN_2022_PROGRAM_ID);
...
export const mintMoreTokens = route;
//# sourceMappingURL=mintMoreTokens.js.map